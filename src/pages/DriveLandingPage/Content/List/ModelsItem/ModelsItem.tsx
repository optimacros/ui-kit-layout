...
export class ModelsItem extends React.Component<Props, State> {
    ...
    render() {
        ...
        const imageIcon = (driveLandingState.isActiveOltpTab)
            ? iconDataBase
            : iconCube
        ...
        return (
            ...
            >
                ...
                <div>
                    <span className={this.styles.DateCreate}>
                        {dateCreate}
                    </span>

                    <span className={this.styles.DateUpdate}>
                        {dateUpdate}
                    </span>

                    <span className={this.styles.VersionBlock}>
                        {storageVersion}
                    </span>
                </div>
                ...
                {isOffline && (
                    <div className={this.styles.Status}>
                        ...
                        <span className={this.styles.Status_offline}>
                            offline
                        </span>
                    </div>
                )}
                ...
                {!isOffline && (
                    <div className={this.styles.Size}>
                        1.2 GB
                    </div>
                )}
    ...
    renderPrivateImage() {
        if (this.props.element.isPrivate) {
            return (
                <ReactSVG
                    className={this.styles.PrivateImage}
                    src={iconPrivate}
                />
            )
        }
